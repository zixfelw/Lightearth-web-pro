// ============================================================
// SOLAR DATA PUSHER - ĐÃ FIX CORS - BẢN CHUẨN NHƯ CONSOLE
// ============================================================

(function() {
    const SERVER_URL = 'https://7000-ivivi5yaau15busmciwnu-c81df28e.sandbox.novita.ai';
    ...
    async function pushDataToServer() {
        try {
            // 1. Fetch data từ lumentree.net API
            const apiUrl = `/api/realtime/${DEVICE_ID}`;
